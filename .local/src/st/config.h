 ...
 */
static char *font = "mono:pixelsize=18:antialias=false:autohint=false";
...
static char *font2[] = { "WenQuanYi Zen Hei Mono:style=Regular:pixelsize=18:antialias=true:autohint=true" };
...
/* bg opacity */
float alpha = 0.7, alphaUnfocused = 0.4;
