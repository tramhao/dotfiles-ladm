...
hl.on("hyprland.start", function () 
  ...
  hl.exec_cmd("~/.config/hypr/xdg_desktop.sh")
  hl.exec_cmd("dbus-update-activation-environment")
  hl.exec_cmd("systemctl")
  hl.exec_cmd("/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1")
  hl.exec_cmd("sleep 2 & wpaperd")
  hl.exec_cmd("pypr")
  hl.exec_cmd("waybar")
  hl.exec_cmd("~/.config/hypr/cleanup_after_start.sh")
  hl.exec_cmd("~/.config/hypr/configure_2nd_monitor.sh")
  hl.exec_cmd("hyprctl setcursor Oxygen_Yellow 48")
  -- hl.exec_cmd("")
  -- hl.exec_cmd("nm-applet")
