...
-- vim.cmd("nnoremap <silent> <leader>ee <cmd> vim.lsp.buf.show_line_diagnostics()<CR>")
vim.cmd("nnoremap <silent> <leader>ee :Lspsaga show_line_diagnostics<CR>")
vim.cmd("nnoremap <silent> <leader>ar :Lspsaga rename<CR>")
