...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-treesitter', 'vim-go', 'completion-nvim'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-treesitter', 'vim-go', 'completion-nvim'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType md ++once lua require("packer.load")({'vim-go', 'vim-markdown', 'glow.nvim', 'completion-nvim'}, { ft = "md" }, _G.packer_plugins)]]
vim.cmd [[au FileType sh ++once lua require("packer.load")({'nvim-treesitter', 'vim-go', 'completion-nvim'}, { ft = "sh" }, _G.packer_plugins)]]
vim.cmd [[au FileType zsh ++once lua require("packer.load")({'nvim-treesitter', 'vim-go', 'completion-nvim'}, { ft = "zsh" }, _G.packer_plugins)]]
